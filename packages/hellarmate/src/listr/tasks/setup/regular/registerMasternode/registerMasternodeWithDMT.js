...
export default function registerMasternodeWithDMTFactory(createIpAndPortsForm) {
  ...
  async function registerMasternodeWithDMT(ctx, task) {
    ...
    See https://docs.hellar.io/dmt-setup for instructions on using Hellar Masternode Tool
    to store your collateral and register your masternode.\n`,
        message: 'Press any key to continue hellarmate setup process...',
        default: ' ',
        separator: () => '',
        format: () => '',
        initial: true,
      ...
      },
      {
        ...
        header: `  Hellarmate needs to collect details on the operator key. The operator
  key is a BLS private key, encoded in hexadecimal format. Hellarmate will record the
