...
export default {
  ...
  properties: {
    ...
    platform: {
              ...
              properties: {
                ...
                validatorSet: {
                  ...
                  properties: {
                    llmqType: {
                      type: 'number',
                      // https://github.com/hellarpay/hellarcore-lib/blob/843176fed9fc81feae43ccf319d99e2dd942fe1f/lib/constants/index.js#L50-L99
                ...
                p2p: {
                  ...
                  properties: {
                    ...
                    persistentPeers: {
                      type: 'array',
                      items: {
                        $ref: '#/definitions/tenderhellarNodeAddress',
                      },
                    },
                    seeds: {
                      type: 'array',
      ...
      required: ['hapi', 'drive', 'hpns', 'hellarpay', 'featureFlags', 'sourcePath', 'masternodeRewardShares', 'withdrawals', 'enable'],
      additionalProperties: false,
    },
    hellarmate: {
      type: 'object',
