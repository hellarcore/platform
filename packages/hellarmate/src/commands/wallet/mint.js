...
export default class MintCommand extends ConfigBaseCommand {
  static description = `Mint tHellar

Mint given amount of tHellar to a new or specified address
`;
    ...
    amount: Args.string(
      {
        name: 'amount',
        required: true,
        description: 'amount of tHellar to be generated to address',
  ...
  async runWithDependencies(
    ...
    if (network !== NETWORK_LOCAL) {
      throw new Error('Only local network supports generation of hellar');
    }

    const tasks = new Listr(
      [
        {
          title: `Generate ${amount} hellar to address`,
