...
export default class StatusCommand extends ConfigBaseCommand {
  ...
  async runWithDependencies(
    ...
    if (flags.format === OUTPUT_FORMATS.PLAIN) {
      ...
      if (platform.enabled) {
        plain['Platform Status'] = colors.status(platform.tenderhellar.serviceStatus)(platform.tenderhellar.serviceStatus) || 'n/a';

        if (platform.tenderhellar.serviceStatus === ServiceStatusEnum.up) {
          plain['Platform Version'] = platform.tenderhellar.version || 'n/a';
          plain['Platform Block Height'] = platform.tenderhellar.latestBlockHeight || 'n/a';
          plain['Platform Peers'] = platform.tenderhellar.peers || 'n/a';
          plain['Platform Network'] = platform.tenderhellar.network || 'n/a';
        }
      }
