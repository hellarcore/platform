  ...
  return {
    ...
    configs: {
      base: {
        ...
        core: {
          docker: {
            image: 'hellarpay/hellard:20.0.0-beta.4',
          },
          p2p: {
            port: 9999,
            seeds: [],
          ...
          log: {
            file: {
              categories: [],
              path: '/Users/hellarmate/.hellarmate/logs/base/core.log',
            },
          },
          logIps: 0,
          indexes: true,
          ...
          drive: {
            abci: {
              ...
              log: {
                ...
                prettyFile: {
                  level: 'silent',
                  path: '/Users/hellarmate/.hellarmate/logs/base/drive-pretty.log',
                },
                jsonFile: {
                  level: 'silent',
                  path: '/Users/hellarmate/.hellarmate/logs/base/drive-json.log',
                },
              },
              validatorSet: {
                llmqType: 4,
            ...
            tenderhellar: {
              mode: 'full',
              docker: {
                image: 'hellarpay/tenderhellar:0.13.2',
              },
              p2p: {
                port: 26656,
                persistentPeers: [],
      ...
      testnet: {
        ...
        core: {
          docker: {
            image: 'hellarpay/hellard:20.0.0-beta.2',
          },
          p2p: {
            port: 19999,
            seeds: [],
          ...
          log: {
            file: {
              categories: [],
              path: '/Users/hellarmate/.hellarmate/logs/testnet/core.log',
            },
          },
          logIps: 0,
          indexes: true,
          ...
          drive: {
            abci: {
              ...
              log: {
                ...
                prettyFile: {
                  level: 'silent',
                  path: '/Users/hellarmate/.hellarmate/logs/testnet/drive-pretty.log',
                },
                jsonFile: {
                  level: 'silent',
                  path: '/Users/hellarmate/.hellarmate/logs/testnet/drive-json.log',
                },
              },
              validatorSet: {
                llmqType: 6,
      ...
      mainnet: {
        ...
        core: {
          docker: {
            image: 'hellarpay/hellard:19.3.0',
          },
          p2p: {
            port: 9999,
            seeds: [],
          ...
          log: {
            file: {
              categories: [],
              path: '/Users/hellarmate/.hellarmate/logs/mainnet/core.log',
            },
          },
          logIps: 0,
          indexes: false,
