...
const SpvChain = class {
  ...
  /** @private
   * validates a hellarcore.BlockHeader object
   *
   * @param {Object} header
   ...
   * between two adjacent hellarcore.BlockHeader objects
   *
   * @param {Object} header
  ...
  /**
   * gets the hellarcore.BlockHeader object the longest chain tip
   *
  ...
  /**
   * gets the hellarcore.BlockHeader object for a specific block hash
   *
   * @param {string} hash
   * @return {Object} header
   */
