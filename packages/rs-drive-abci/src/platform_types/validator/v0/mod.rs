...
use hellarcore_rpc::hellarcore::{ProTxHash, PubkeyHash};
use hellarcore_rpc::hellarcore_rpc_json::{DMNState, MasternodeListItem};
...
pub trait ValidatorV0Getters {
    ...
    /// Returns the Tenderhellar port of the validator.
...
pub trait ValidatorV0Setters {
    ...
    /// Sets the Tenderhellar port of the validator.
