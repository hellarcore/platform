...
use tenderhellar_abci::proto::abci::CommitInfo;
use tenderhellar_abci::proto::types::BlockId;
...
impl Commit {
    /// Create new Commit struct based on commit info and block id received from Tenderhellar
