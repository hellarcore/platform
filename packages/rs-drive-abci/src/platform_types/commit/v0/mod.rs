//! Processing of commits generated by Tenderhellar
...
use hpp::validation::{SimpleValidationResult, ValidationResult};
...
impl CommitV0 {
    ...
    pub(super) fn verify_signature(
        ...
        let hash = match self
            ...
            .map_err(AbciError::Tenderhellar)
        {
            Ok(hash) => hash,
            Err(e) => return ValidationResult::new_with_error(e),
        };
...
mod test {
    ...
    use hellarcore_rpc::{
        hellarcore::hashes::sha256, hellarcore::hashes::Hash, hellarcore_rpc_json::QuorumType,
    };
    use hpp::bls_signatures::PublicKey;

    use tenderhellar_abci::proto::types::{BlockId, PartSetHeader, StateId};
