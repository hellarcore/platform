...
mod test {
    pub mod query_data_contract_history {
        ...
        use hpp::data_contract::config::v0::DataContractConfigSettersV0;

        use crate::error::query::QueryError;
        use hapi_grpc::platform::v0::get_data_contract_history_request::GetDataContractHistoryRequestV0;
        use hapi_grpc::platform::v0::get_data_contract_history_response::{
        ...
        use hpp::serialization::PlatformDeserializableWithPotentialValidationFromVersionedStructure;
