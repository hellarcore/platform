...
use hapi_grpc::platform::v0::get_data_contract_request::GetDataContractRequestV0;
use hapi_grpc::platform::v0::get_data_contract_response::GetDataContractResponseV0;
use hapi_grpc::platform::v0::{get_data_contract_response, GetDataContractResponse, Proof};
