...
use hapi_grpc::platform::v0::get_data_contract_history_response::GetDataContractHistoryResponseV0;
...
use prost::Message;
use hapi_grpc::platform::v0::get_data_contract_history_response::get_data_contract_history_response_v0::DataContractHistoryEntry;
