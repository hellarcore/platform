...
use hapi_grpc::platform::v0::get_data_contracts_request::GetDataContractsRequestV0;
use hapi_grpc::platform::v0::get_data_contracts_response::DataContractEntry;
use hapi_grpc::platform::v0::get_data_contracts_response::GetDataContractsResponseV0;
use hapi_grpc::platform::v0::{get_data_contracts_response, GetDataContractsResponse, Proof};
...
use hpp::{check_validation_result_with_data, ProtocolError};
use prost::Message;
