...
use hapi_grpc::platform::v0::get_identity_keys_request::GetIdentityKeysRequestV0;
use hapi_grpc::platform::v0::get_identity_keys_response::GetIdentityKeysResponseV0;
use hapi_grpc::platform::v0::{get_identity_keys_response, GetIdentityKeysResponse, Proof};
...
use hpp::identity::{KeyID, Purpose, SecurityLevel};
...
fn convert_key_request_type(
    request_type: hapi_grpc::platform::v0::key_request_type::Request,
) -> Result<KeyRequestType, QueryError> {
    match request_type {
        hapi_grpc::platform::v0::key_request_type::Request::AllKeys(_) => {
            Ok(KeyRequestType::AllKeys)
        }
        hapi_grpc::platform::v0::key_request_type::Request::SpecificKeys(specific_keys) => {
        ...
        hapi_grpc::platform::v0::key_request_type::Request::SearchKey(search_key) => {
