...
use hapi_grpc::platform::v0::get_identity_balance_response::GetIdentityBalanceResponseV0;
use hapi_grpc::platform::v0::get_identity_request::GetIdentityRequestV0;
use hapi_grpc::platform::v0::{get_identity_balance_response, GetIdentityBalanceResponse, Proof};
