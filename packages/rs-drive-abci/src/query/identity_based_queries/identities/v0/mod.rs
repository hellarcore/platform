...
use hapi_grpc::platform::v0::get_identities_response::{GetIdentitiesResponseV0, IdentityEntry};
use hapi_grpc::platform::v0::{get_identities_response, GetIdentitiesResponse, Proof};
