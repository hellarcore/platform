...
use hapi_grpc::platform::v0::get_proofs_request::GetProofsRequestV0;
use hapi_grpc::platform::v0::get_proofs_response::GetProofsResponseV0;
use hapi_grpc::platform::v0::{get_proofs_response, GetProofsResponse, Proof};
