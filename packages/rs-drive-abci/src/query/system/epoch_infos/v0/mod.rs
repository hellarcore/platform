...
use hapi_grpc::platform::v0::get_epochs_info_request::GetEpochsInfoRequestV0;
use hapi_grpc::platform::v0::get_epochs_info_response::get_epochs_info_response_v0::EpochInfos;
use hapi_grpc::platform::v0::get_epochs_info_response::GetEpochsInfoResponseV0;
