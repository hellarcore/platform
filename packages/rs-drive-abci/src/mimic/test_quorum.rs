...
use hellarcore_rpc::hellarcore::{ProTxHash, PubkeyHash, QuorumHash};
use hellarcore_rpc::hellarcore_rpc_json::{QuorumInfoResult, QuorumMember, QuorumType};
use hpp::bls_signatures;
use hpp::bls_signatures::{PrivateKey as BlsPrivateKey, PublicKey as BlsPublicKey};
...
impl TestQuorumInfo {
    ...
    pub fn from_quorum_hash_and_pro_tx_hashes(
        ...
        let private_keys = bls_signatures::PrivateKey::generate_hellar_many(pro_tx_hashes.len(), rng)
