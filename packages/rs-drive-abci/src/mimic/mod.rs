...
use hellarcore_rpc::hellarcore::blockdata::transaction::special_transaction::asset_unlock::qualified_asset_unlock::AssetUnlockPayload;
use hellarcore_rpc::hellarcore::blockdata::transaction::special_transaction::asset_unlock::request_info::AssetUnlockRequestInfo;
use hellarcore_rpc::hellarcore::blockdata::transaction::special_transaction::asset_unlock::unqualified_asset_unlock::AssetUnlockBaseTransactionInfo;
use hellarcore_rpc::hellarcore::blockdata::transaction::special_transaction::TransactionPayload::AssetUnlockPayloadType;
use hellarcore_rpc::hellarcore::bls_sig_utils::BLSSignature;
use hellarcore_rpc::hellarcore::consensus::Decodable;
...
use tenderhellar_abci::proto::abci::{CommitInfo, ExecTxResult, RequestExtendVote, RequestFinalizeBlock, RequestPrepareProposal, RequestProcessProposal, RequestVerifyVoteExtension, ResponsePrepareProposal, ValidatorSetUpdate};
use tenderhellar_abci::proto::google::protobuf::Timestamp;
use tenderhellar_abci::proto::serializers::timestamp::ToMilis;
use tenderhellar_abci::proto::types::{
    Block, BlockId, Data, EvidenceList, Header, PartSetHeader, VoteExtension, VoteExtensionType, StateId, CanonicalVote, SignedMsgType,
};
use tenderhellar_abci::signatures::SignBytes;
use tenderhellar_abci::{signatures::SignDigest, proto::version::Consensus, Application};
...
pub struct MimicExecuteBlockOutcome {
    ...
    pub withdrawal_transactions: Vec<hellarcore_rpc::hellarcore::Transaction>,
    /// The next validators
