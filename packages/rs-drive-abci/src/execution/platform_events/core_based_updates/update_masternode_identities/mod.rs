...
//     use hellarcore_rpc::hellarcore_rpc_json::MasternodeListDiffWithMasternodes;
//     use hellarcore_rpc::json::MasternodeType::Regular;
//     use hellarcore_rpc::json::{DMNState, MasternodeListItem};
