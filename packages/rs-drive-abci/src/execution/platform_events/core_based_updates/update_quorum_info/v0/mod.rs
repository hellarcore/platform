    ...
    C: CoreRPCLike,
{
    ...
    pub(super) fn update_quorum_info_v0(
        ...
        let validator_quorums_list: BTreeMap<_, _> = extended_quorum_list
            ...
            .ok_or(Error::Execution(ExecutionError::hellarcoreBadResponseError(
                format!(
                    "expected quorums of type {}, but did not receive any from Hellar Core",
