...
use drive::hpp::identifier::Identifier;
use drive::hpp::identity::convert_credits_to_duffs;
...
mod tests {
    ...
    mod build_withdrawal_transactions_from_documents {
        ...
        use hpp::data_contracts::withdrawals_contract::document_types::withdrawal;
