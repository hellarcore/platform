...
use hpp::data_contracts::withdrawals_contract::WithdrawalStatus;
...
use hpp::system_data_contracts::withdrawals_contract;
use hpp::system_data_contracts::withdrawals_contract::document_types::withdrawal;
...
#[cfg(test)]
mod tests {
    use hellarcore_rpc::hellarcore::{hashes::hex::FromHex, BlockHash, QuorumHash};
    use hellarcore_rpc::hellarcore_rpc_json::GetTransactionLockedResult;
    use hpp::{
