...
use hpp::hellarcore::secp256k1::ThirtyTwoByteHash;
use hpp::hellarcore::transaction::special_transaction::TransactionPayload;
use hpp::hellarcore::TxOut;
use hpp::identity::state_transition::asset_lock_proof::validate_asset_lock_transaction_structure::validate_asset_lock_transaction_structure;
use hpp::prelude::{AssetLockProof, ConsensusValidationResult};
    ...
    match asset_lock_proof {
        ...
        AssetLockProof::Chain(proof) => {
            ...
            let maybe_transaction_info = core_rpc
                ...
                .map_err(|e| {
                    Error::Execution(ExecutionError::hellarcoreBadResponseError(format!(
            ...
            let transaction = transaction_info
                .transaction()
                .map_err(|e| Error::Execution(ExecutionError::hellarcoreConsensusEncodeError(e)))?;
