...
use hpp::{document, ProtocolError};
...
mod tests {
    ...
    use hpp::platform_value::{platform_value, Bytes32};
    ...
    use hpp::tests::fixtures::{get_data_contract_fixture, get_withdrawal_document_fixture};
    use hpp::version::PlatformVersion;
    ...
    fn should_throw_error_if_withdrawal_not_found() {
        ...
        let base_transition: DocumentBaseTransitionAction = DocumentBaseTransitionActionV0 {
            ...
            data_contract: Arc::new(DataContractFetchInfo::hpns_contract_fixture(1)),
        }
        .into();
