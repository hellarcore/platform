...
use hpp::system_data_contracts::feature_flags_contract;
use hpp::system_data_contracts::feature_flags_contract::document_types::update_consensus_params::properties::PROPERTY_ENABLE_AT_HEIGHT;
...
mod test {
    ...
    //         data_contract: Arc::new(DataContractFetchInfo::hpns_contract_fixture(
