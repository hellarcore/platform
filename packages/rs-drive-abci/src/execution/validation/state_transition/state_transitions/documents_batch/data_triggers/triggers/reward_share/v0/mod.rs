...
use hpp::system_data_contracts::masternode_reward_shares_contract::document_types::reward_share::properties::{PAY_TO_ID, PERCENTAGE};
...
mod test {
    ...
    use hellarcore_rpc::hellarcore::{ProTxHash, Txid};
    use hellarcore_rpc::hellarcore_rpc_json::{DMNState, MasternodeListItem, MasternodeType};
    ...
    use hpp::document::{Document, DocumentV0Setters};
    use hpp::identity::Identity;

    use hpp::platform_value::{Bytes32, Identifier, Value};
    ...
    use hpp::consensus::state::data_trigger::DataTriggerError;
    ...
    use hpp::identity::accessors::IdentitySettersV0;
