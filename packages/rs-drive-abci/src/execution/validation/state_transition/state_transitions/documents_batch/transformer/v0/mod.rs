...
use hpp::consensus::basic::document::{DataContractNotPresentError, InvalidDocumentTypeError};
use hpp::consensus::basic::BasicError;

use hpp::consensus::state::document::document_not_found_error::DocumentNotFoundError;
use hpp::consensus::state::document::document_owner_id_mismatch_error::DocumentOwnerIdMismatchError;

use hpp::consensus::state::document::invalid_document_revision_error::InvalidDocumentRevisionError;
use hpp::consensus::state::state_error::StateError;
use hpp::data_contract::accessors::v0::DataContractV0Getters;

use hpp::document::{Document, DocumentV0Getters};
use hpp::validation::SimpleConsensusValidationResult;
use hpp::{consensus::ConsensusError, prelude::Identifier, validation::ConsensusValidationResult};

use hpp::state_transition::documents_batch_transition::{DocumentsBatchTransition};
use hpp::state_transition::documents_batch_transition::accessors::DocumentsBatchTransitionAccessorsV0;
use hpp::state_transition::documents_batch_transition::document_base_transition::v0::v0_methods::DocumentBaseTransitionV0Methods;
use hpp::state_transition::documents_batch_transition::document_transition::{DocumentTransition, DocumentReplaceTransition, DocumentTransitionV0Methods};
use hpp::state_transition::StateTransitionLike;
...
use hpp::state_transition::documents_batch_transition::document_transition::document_replace_transition::v0::v0_methods::DocumentReplaceTransitionV0Methods;
