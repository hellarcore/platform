...
use crate::execution::validation::state_transition::documents_batch::data_triggers::triggers::hpns::create_domain_data_trigger;
...
use hpp::errors::ProtocolError;
use hpp::system_data_contracts::feature_flags_contract::document_types::update_consensus_params;
use hpp::system_data_contracts::withdrawals_contract::document_types::withdrawal;
use hpp::system_data_contracts::{hellarpay_contract, hpns_contract, SystemDataContract};
...
pub fn data_trigger_bindings_list_v0() -> Result<Vec<DataTriggerBindingV0>, ProtocolError> {
    let data_triggers = vec![
        DataTriggerBindingV0 {
            data_contract_id: hpns_contract::ID,
        ...
        DataTriggerBindingV0 {
            data_contract_id: hellarpay_contract::ID,
