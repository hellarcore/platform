///! The `hellarpay_data_triggers` module contains data triggers specific to the HellarPay data contract.
...
use hpp::platform_value::btreemap_extensions::BTreeValueMapHelper;
...
use hpp::system_data_contracts::hellarpay_contract::document_types::contact_request::properties::{CORE_HEIGHT_CREATED_AT, TO_USER_ID};
...
mod test {
    ...
    use hpp::block::extended_block_info::v0::ExtendedBlockInfoV0;
    use std::sync::Arc;

    use hpp::document::{DocumentV0Getters, DocumentV0Setters};
    use hpp::platform_value;
    use hpp::platform_value::{Bytes32, platform_value};
    ...
    use crate::execution::validation::state_transition::documents_batch::data_triggers::triggers::hellarpay::create_contact_request_data_trigger;
    use crate::platform_types::platform::PlatformStateRef;
    use crate::test::helpers::setup::TestPlatformBuilder;
    use super::*;
    use hpp::errors::consensus::state::data_trigger::DataTriggerError;
    use hpp::tests::fixtures::{get_contact_request_document_fixture, get_hellarpay_contract_fixture, get_document_transitions_fixture, get_identity_fixture};
    ...
    fn should_successfully_execute_on_dry_run() {
        ...
        let data_contract =
            get_hellarpay_contract_fixture(None, protocol_version).data_contract_owned();
        ...
        let result = create_contact_request_data_trigger(
            &DocumentCreateTransitionAction::from_document_borrowed_create_transition_with_contract_lookup(document_create_transition, |_identifier| {
                Ok(Arc::new(DataContractFetchInfo::hellarpay_contract_fixture(protocol_version)))
    ...
    fn should_fail_if_owner_id_equals_to_user_id() {
        ...
        let data_contract = get_hellarpay_contract_fixture(
            None,
            state_write_guard.current_protocol_version_in_consensus(),
        )
        .data_contract_owned();
        ...
        let _hellarpay_identity_id = data_trigger_context.owner_id.to_owned();
