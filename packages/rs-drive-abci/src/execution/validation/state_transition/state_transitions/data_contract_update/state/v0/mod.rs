...
use hpp::consensus::basic::data_contract::{
    DataContractInvalidIndexDefinitionUpdateError, IncompatibleDataContractSchemaError,
    InvalidDataContractVersionError,
};
use hpp::consensus::basic::document::DataContractNotPresentError;
use hpp::consensus::basic::BasicError;
use hpp::consensus::state::data_contract::data_contract_is_readonly_error::DataContractIsReadonlyError;
...
use hpp::data_contract::document_type::schema::{
...
use hpp::platform_value::{Value, ValueMap};
