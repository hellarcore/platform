...
use hpp::validation::{ConsensusValidationResult, SimpleConsensusValidationResult};
...
mod tests {
    ...
    mod validate_state {
        ...
        use hpp::assert_state_consensus_errors;
        use hpp::consensus::state::state_error::StateError;
        use hpp::consensus::state::state_error::StateError::DataContractIsReadonlyError;
        ...
        use hpp::version::TryFromPlatformVersioned;
