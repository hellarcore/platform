...
use hpp::hellarcore::InstantLock;
...
impl CoreSignatureVerification for InstantLock {
    fn verify_signature<C: CoreRPCLike>(
        ...
        match core_rpc.verify_instant_lock(self, Some(core_chain_locked_height)) {
            ...
            Err(hellarcore_rpc::Error::JsonRpc(hellarcore_rpc::jsonrpc::error::Error::Rpc(
            ...
            Err(e) => Err(Error::Execution(ExecutionError::hellarcoreBadResponseError(
