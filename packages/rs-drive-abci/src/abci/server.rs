...
/// AbciApp is an implementation of ABCI Application, as defined by Tenderhellar.
///
/// AbciApp implements logic that should be triggered when Tenderhellar performs various operations, like
...
pub fn start<C: CoreRPCLike>(
    ...
    let server = tenderhellar_abci::ServerBuilder::new(abci, &bind_address)
