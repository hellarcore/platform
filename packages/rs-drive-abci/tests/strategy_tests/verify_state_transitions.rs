use hapi_grpc::platform::v0::{get_proofs_request, GetProofsRequest, GetProofsResponse};
use hapi_grpc::platform::VersionedGrpcResponse;

use hapi_grpc::platform::v0::get_proofs_request::{get_proofs_request_v0, GetProofsRequestV0};
use hpp::block::block_info::BlockInfo;
use hpp::data_contract::accessors::v0::DataContractV0Getters;
use hpp::document::Document;
use hpp::identity::PartialIdentity;
