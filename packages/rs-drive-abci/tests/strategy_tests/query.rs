...
use hapi_grpc::platform::v0::get_identities_by_public_key_hashes_request::GetIdentitiesByPublicKeyHashesRequestV0;
use hapi_grpc::platform::v0::get_identities_by_public_key_hashes_response::PublicKeyHashIdentityEntry;
use hapi_grpc::platform::v0::{
...
use hellarcore_rpc::hellarcore_rpc_json::QuorumType;
use hpp::identity::accessors::IdentityGettersV0;
use hpp::identity::identity_public_key::accessors::v0::IdentityPublicKeyGettersV0;
use hpp::identity::identity_public_key::methods::hash::IdentityPublicKeyHashMethodsV0;
use hpp::identity::{Identity, PartialIdentity};
...
use tenderhellar_abci::proto::google::protobuf::Timestamp;
use tenderhellar_abci::proto::serializers::timestamp::ToMilis;
use tenderhellar_abci::proto::types::{CanonicalVote, SignedMsgType, StateId};
use tenderhellar_abci::signatures::{SignBytes, SignDigest};
...
/// ProofVerification contains trusted data from Platform chain (Tenderhellar) needed to verify proofs at given `height`.
///
/// See https://github.com/hellarpay/tenderhellar/blob/v0.12-dev/spec/consensus/signing.md#block-signature-verification-on-light-client
#[derive(Debug, Clone)]
pub struct ProofVerification<'a> {
    ...
    pub public_key: &'a hpp::bls_signatures::PublicKey,
}
...
impl<'a> ProofVerification<'a> {
    ...
    /// https://github.com/hellarpay/tenderhellar/blob/v0.12-dev/spec/consensus/signing.md#block-signature-verification-on-light-client
    fn verify_signature(&self, state_id: StateId, round: u32) -> SimpleValidationResult<AbciError> {
        ...
        let signature = match hpp::bls_signatures::Signature::from_bytes(self.signature) {
            Ok(signature) => signature,
            Err(e) => {
                return SimpleValidationResult::new_with_error(
                    AbciError::BlsErrorOfTenderhellarThresholdMechanism(
                        e,
...
mod tests {
    ...
    use hellarcore_rpc::hellarcore::hashes::Hash;
    use hellarcore_rpc::hellarcore::BlockHash;
    use hellarcore_rpc::hellarcore_rpc_json::ExtendedQuorumDetails;
    ...
    use hapi_grpc::platform::v0::get_epochs_info_request::{GetEpochsInfoRequestV0, Version};
    use hapi_grpc::platform::v0::{
        get_epochs_info_response, GetEpochsInfoRequest, GetEpochsInfoResponse,
    };
    use hpp::block::epoch::EpochIndex;
    use hpp::block::extended_epoch_info::v0::ExtendedEpochInfoV0Getters;
    use hpp::data_contract::accessors::v0::{DataContractV0Getters, DataContractV0Setters};
    ...
    use hpp::identity::identity_public_key::accessors::v0::IdentityPublicKeyGettersV0;
    use hpp::serialization::PlatformDeserializable;
    use hpp::tests::json_document::json_document_to_created_contract;
    use hpp::util::hash::hash_to_hex_string;
    use hpp::version::PlatformVersion;
    ...
    use tenderhellar_abci::proto::abci::{RequestInfo, ResponseInfo};
    use tenderhellar_abci::proto::types::CoreChainLock;
    use tenderhellar_abci::Application;
