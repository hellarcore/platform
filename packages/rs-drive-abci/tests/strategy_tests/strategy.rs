...
use hellarcore_rpc::hellarcore;
use hellarcore_rpc::hellarcore::{ProTxHash, QuorumHash};
use hpp::block::block_info::BlockInfo;
use hpp::data_contract::created_data_contract::CreatedDataContract;
...
use hpp::serialization::PlatformSerializableWithPlatformVersion;
...
use tenderhellar_abci::proto::abci::{ExecTxResult, ValidatorSetUpdate};
...
pub struct ChainExecutionOutcome<'a> {
    ...
    pub withdrawals: Vec<hellarcore::Transaction>,
