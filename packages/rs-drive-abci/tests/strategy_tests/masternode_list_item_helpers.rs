...
use hellarcore_rpc::json::MasternodeListItem;
    ...
    fn random_keys_update(&mut self, num_fields_to_change: Option<usize>, rng: &mut StdRng) {
        ...
        for _ in 0..fields_to_change {
            ...
            match field_idx {
                ...
                3 => {
                    let private_key_operator = BlsPrivateKey::generate_hellar(rng)
...
mod tests {
    ...
    use hellarcore_rpc::hellarcore_rpc_json::{DMNState, MasternodeType};
    ...
    fn test_random_keys_update_determinism() {
        ...
        let private_key_operator =
            BlsPrivateKey::generate_hellar(&mut rng).expect("expected to generate a private key");
        let pub_key_operator = private_key_operator
            .g1_element()
            .expect("expected to get public key")
            .to_bytes()
