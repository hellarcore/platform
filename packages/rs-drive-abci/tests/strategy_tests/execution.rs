...
use hellarcore_rpc::hellarcore::{BlockHash, ProTxHash, QuorumHash};
...
use hellarcore_rpc::json::{ExtendedQuorumListResult, SoftforkInfo};
...
use tenderhellar_abci::proto::abci::{ResponseInitChain, ValidatorSetUpdate};
use tenderhellar_abci::proto::crypto::public_key::Sum::Bls12381;
use tenderhellar_abci::proto::google::protobuf::Timestamp;
use tenderhellar_abci::proto::serializers::timestamp::FromMilis;
...
pub(crate) fn start_chain_for_strategy(
    ...
    init_chain_request.validator_set = Some(ValidatorSetUpdate {
        validator_updates: current_quorum_with_test_info
            ...
            .iter()
            .map(
                |validator_in_quorum| tenderhellar_abci::proto::abci::ValidatorUpdate {
                    pub_key: Some(tenderhellar_abci::proto::crypto::PublicKey {
            ...
            .collect(),
        threshold_public_key: Some(tenderhellar_abci::proto::crypto::PublicKey {
            sum: Some(Bls12381(
