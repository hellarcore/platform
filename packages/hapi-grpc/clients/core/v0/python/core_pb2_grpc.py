...
def add_CoreServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'org.hellar.platform.hapi.v0.Core', rpc_method_handlers)
...
class Core(object):
    ...
    def getStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/org.hellar.platform.hapi.v0.Core/getStatus',
    ...
    def getBlock(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/org.hellar.platform.hapi.v0.Core/getBlock',
    ...
    def broadcastTransaction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/org.hellar.platform.hapi.v0.Core/broadcastTransaction',
    ...
    def getTransaction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/org.hellar.platform.hapi.v0.Core/getTransaction',
    ...
    def getEstimatedTransactionFee(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/org.hellar.platform.hapi.v0.Core/getEstimatedTransactionFee',
    ...
    def subscribeToBlockHeadersWithChainLocks(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/org.hellar.platform.hapi.v0.Core/subscribeToBlockHeadersWithChainLocks',
    ...
    def subscribeToTransactionsWithProofs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/org.hellar.platform.hapi.v0.Core/subscribeToTransactionsWithProofs',
