use anyhow::anyhow;
use hellarcore_rpc::hellarcore::signer;
use hpp::bincode::{Decode, Encode};
use hpp::ed25519_dalek::Signer as BlsSigner;
use hpp::identity::identity_public_key::accessors::v0::IdentityPublicKeyGettersV0;
use hpp::identity::signer::Signer;
use hpp::identity::{IdentityPublicKey, KeyType};
use hpp::platform_value::BinaryData;
use hpp::state_transition::errors::{
    InvalidIdentityPublicKeyTypeError, InvalidSignaturePublicKeyError,
};
use hpp::{bls_signatures, ed25519_dalek, ProtocolError};
