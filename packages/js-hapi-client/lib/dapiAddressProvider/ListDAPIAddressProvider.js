const sample = require('lohellar/sample');
const networks = require('@hellarpro/hellarcore-lib/lib/networks');

class ListHAPIAddressProvider {
  /**
   * @param {HAPIAddress[]} addresses
  ...
  /**
   * Get random address
   * @returns {Promise<HAPIAddress|undefined>}
   */
   ...
   * Set addresses
   * @param {HAPIAddress[]} addresses
   * @returns {ListHAPIAddressProvider}
   */
...
module.exports = ListHAPIAddressProvider;
