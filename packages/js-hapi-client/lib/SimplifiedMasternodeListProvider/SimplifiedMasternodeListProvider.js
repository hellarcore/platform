const SimplifiedMNList = require('@hellarpro/hellarcore-lib/lib/deterministicmnlist/SimplifiedMNList');
const SimplifiedMNListDiff = require('@hellarpro/hellarcore-lib/lib/deterministicmnlist/SimplifiedMNListDiff');
...
class SimplifiedMasternodeListProvider {
  ...
  /**
   * Fetches masternode diff from HAPI
   * @private
