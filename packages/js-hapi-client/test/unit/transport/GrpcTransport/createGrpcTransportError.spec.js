const { Metadata, parseMetadata } = require('@hellarpro/hapi-grpc');
...
describe('createGrpcTransportError', () => {
  ...
  beforeEach(() => {
    hapiAddress = new HAPIAddress('127.0.0.1:3001:3002');
    errorData = {
      errorData: 'some data',
    };
  ...
  it('should return NotFoundError', async () => {
    ...
    expect(error.getHAPIAddress()).to.deep.equal(hapiAddress);
