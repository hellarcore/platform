...
const { HDPrivateKey, Transaction } = require('@hellarpro/hellarcore-lib');
...
describe('Account - createTransaction', function suite() {
  ...
  it('sould warn on missing inputs', function () {
    ...
    const expectedException1 = 'An amount in hellar or in satoshis is expected to create a transaction';
