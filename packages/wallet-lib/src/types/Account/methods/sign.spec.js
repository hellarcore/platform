...
describe('Account - sign', function suite() {
  ...
  it('should sign a transaction with a message', function () {
    account
      .importTransactions([[
        new hellarcore.Transaction(transactions["4e2a8b05a805fcee959b8ecfd5557e196a9b8490dd280d6f599b391d650407c8"]),
        { height: 20, time: new Date()}
      ]]);
    const transaction = account.createTransaction({
      recipient: 'yNPbcFfabtNmmxKdGwhHomdYfVs6gikbPf', // Evonet faucet
      satoshis: 1000000, // 1 Hellar
    });
  ...
  it('should sign and verify a message', () => {
    ...
    const message = new hellarcore.Message('hello, world');
