const BlockHeadersProvider = require('@hellarpro/hapi-client/lib/BlockHeadersProvider/BlockHeadersProvider');
const ReconnectableStream = require('@hellarpro/hapi-client/lib/transport/ReconnectableStream');
