...
const { Transaction, PrivateKey } = require('@hellarpro/hellarcore-lib');
...
const { mockMerkleBlock } = require('../../../test/mocks/hellarcore/block');
const { mockInstantLock } = require('../../../test/mocks/hellarcore/instantlock');
