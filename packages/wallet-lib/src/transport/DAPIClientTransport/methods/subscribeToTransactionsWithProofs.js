...
/**
 * From a given addressList will create and submit a bloomfilter to HAPI
...
module.exports = async function subscribeToTransactionsWithProofs(
  ...
  const { client } = this;
  logger.silly(`HAPIClient.subscribeToTransactionWithProofs[${addressList}](len:${addressList.length})`);
