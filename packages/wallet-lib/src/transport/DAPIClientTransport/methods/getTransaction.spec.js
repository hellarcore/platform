...
const GetTransactionResponse = require('@hellarpro/hapi-client/lib/methods/core/getTransaction/GetTransactionResponse');

describe('transports - HAPIClientTransport .getTransaction', function suite() {
  let fixture;
  let transport;
  let clientMock;
