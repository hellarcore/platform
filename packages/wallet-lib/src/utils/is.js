...
const is = {
  ...
  publicKey: (pKey) => !is.undefOrNull(pKey) && (pKey.constructor.name === PublicKey.name || (is.string(pKey) && PublicKey.isValid(pKey))),
  ...
  hellarcoreTransaction: (tx) => is.type(tx, Transaction.name),
