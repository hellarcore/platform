...
import { default as _HAPIClient } from '@hellarpro/hapi-client';
import {
  Wallet as _Wallet,
  Account as _Account,
...
export namespace SDK {
  export const HAPIClient = _HAPIClient;
  ...
  export const PlatformProtocol = Platform.HellarPlatformProtocol;
