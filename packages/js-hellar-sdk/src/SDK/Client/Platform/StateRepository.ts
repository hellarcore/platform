import { DataContract, Identity, Identifier } from '@hellarpro/wasm-hpp';
...
class StateRepository {
  ...
  async verifyInstantLock(): Promise<boolean> {
    // verification will be implemented later with HAPI SPV functionality
    return true;
  }
  ...
  async fetchTransaction(id: string): Promise<{ data: Buffer, height: number }> {
    ...
    return {
      ...
      // and it will be implemented later with HAPI SPV functionality
      height: 1,
    };
  }
