...
import { Identifier } from '@hellarpro/wasm-hpp/dist';
import { GetDataContractResponse } from '@hellarpro/hapi-client/lib/methods/platform/getDataContract/GetDataContractResponse';
import { GetIdentityResponse } from '@hellarpro/hapi-client/lib/methods/platform/getIdentity/GetIdentityResponse';

import NotFoundError from '@hellarpro/hapi-client/lib/transport/GrpcTransport/errors/NotFoundError';
import { GetDocumentsResponse } from '@hellarpro/hapi-client/lib/methods/platform/getDocuments/GetDocumentsResponse';
import {
  GetDataContractHistoryResponse,
} from '@hellarpro/hapi-client/lib/methods/platform/getDataContractHistory/GetDataContractHistoryResponse';
...
class Fetcher {
  ...
  constructor(hapiClient: HAPIClient, options: FetcherOptions = {}) {
  ...
  public async fetchIdentity(id: Identifier): Promise<GetIdentityResponse> {
    ...
    const query = async (): Promise<GetIdentityResponse> => {
      const { platform } = this.hapiClient;
  ...
  public async fetchDataContractHistory(
    ...
    const query = async (): Promise<GetDataContractHistoryResponse> => await this
      .hapiClient.platform.getDataContractHistory(id, startAMs, limit, offset);
  ...
  public async fetchDocuments(
    ...
    const query = async (): Promise<GetDocumentsResponse> => {
      const result = await this.hapiClient.platform
