...
const { InstantLockTimeoutError, TxMetadataTimeoutError } = require('@hellarpro/wallet-lib/src/errors');
  ...
  return Promise.race([
    ...
    instantLockPromise
      .then((instantLock) => {
        ...
        return hpp.identity.createInstantAssetLockProof(
    ...
    txMetadataPromise
      ...
      // @ts-ignore
        ...
        .then(() => {
          ...
          return hpp.identity.createChainAssetLockProof(
            // @ts-ignore
