...
use hpp::data_contract::created_data_contract::{
    CreatedDataContract, CreatedDataContractInSerializationFormat,
};
use hpp::data_contract::document_type::random_document::CreateRandomDocument;
use hpp::data_contract::DataContract;

use hpp::document::DocumentV0Getters;
use hpp::identity::{Identity, KeyType, Purpose, SecurityLevel};
use hpp::serialization::{
    PlatformDeserializableWithPotentialValidationFromVersionedStructure,
    PlatformSerializableWithPlatformVersion,
};
use hpp::state_transition::data_contract_create_transition::DataContractCreateTransition;
...
use hpp::state_transition::data_contract_update_transition::methods::DataContractUpdateTransitionMethodsV0;
...
use hpp::data_contract::document_type::accessors::DocumentTypeV0Getters;
use hpp::identity::accessors::IdentityGettersV0;
use hpp::platform_value::BinaryData;
use hpp::ProtocolError;
use hpp::ProtocolError::{PlatformDeserializationError, PlatformSerializationError};
use hpp::state_transition::documents_batch_transition::document_base_transition::v0::DocumentBaseTransitionV0;
use hpp::state_transition::documents_batch_transition::document_create_transition::{DocumentCreateTransition, DocumentCreateTransitionV0};
use hpp::state_transition::documents_batch_transition::document_transition::document_delete_transition::DocumentDeleteTransitionV0;
use hpp::state_transition::documents_batch_transition::document_transition::document_replace_transition::DocumentReplaceTransitionV0;
use hpp::state_transition::documents_batch_transition::{DocumentsBatchTransition, DocumentsBatchTransitionV0};
use hpp::state_transition::documents_batch_transition::document_transition::{DocumentDeleteTransition, DocumentReplaceTransition};
use drive::drive::document::query::QueryDocumentsOutcomeV0Methods;
use hpp::state_transition::data_contract_create_transition::methods::v0::DataContractCreateTransitionMethodsV0;
...
mod tests {
    ...
    fn serialize_deserialize_strategy() {
        ...
        let hpns_contract =
            load_system_data_contract(SystemDataContract::HPNS, platform_version.protocol_version)
                .expect("data contract");

        let document_op_1 = DocumentOp {
            contract: hpns_contract.clone(),
            action: DocumentAction::DocumentActionInsertSpecific(
                BTreeMap::from([
                    ("label".into(), "simon1".into()),
                    ("normalizedLabel".into(), "s1m0n1".into()),
                    ("normalizedParentDomainName".into(), "hellar".into()),
                    (
                        "records".into(),
                        BTreeMap::from([(
