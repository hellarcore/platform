...
use hpp::hellarcore::secp256k1::SecretKey;
use hpp::hellarcore::{
    bls_sig_utils::BLSSignature, hash_types::CycleHash, InstantLock, OutPoint, ScriptBuf,
    Transaction, TxIn, TxOut, Txid,
};
use hpp::hellarcore::{Network, PrivateKey};
use hpp::identifier::Identifier;
use hpp::identity::accessors::{IdentityGettersV0, IdentitySettersV0};
use hpp::identity::core_script::CoreScript;
use hpp::identity::identity_public_key::accessors::v0::{
    IdentityPublicKeyGettersV0, IdentityPublicKeySettersV0,
};
use hpp::identity::state_transition::asset_lock_proof::InstantAssetLockProof;
use hpp::identity::KeyType::ECDSA_SECP256K1;
use hpp::identity::Purpose::AUTHENTICATION;
use hpp::identity::SecurityLevel::{CRITICAL, MASTER};
use hpp::identity::{Identity, IdentityPublicKey, KeyID, KeyType, Purpose, SecurityLevel};
...
use hpp::state_transition::identity_credit_transfer_transition::v0::IdentityCreditTransferTransitionV0;

use hpp::state_transition::identity_credit_withdrawal_transition::v0::IdentityCreditWithdrawalTransitionV0;
...
use hpp::state_transition::identity_update_transition::methods::IdentityUpdateTransitionMethodsV0;
use hpp::state_transition::identity_update_transition::IdentityUpdateTransition;
use hpp::state_transition::{GetDataContractSecurityLevelRequirementFn, StateTransition};
use hpp::version::PlatformVersion;
use hpp::withdrawal::Pooling;
use hpp::NativeBlsModule;
use rand::prelude::{IteratorRandom, StdRng};
use simple_signer::signer::SimpleSigner;

use hpp::hellarcore::transaction::special_transaction::asset_lock::AssetLockPayload;
use hpp::hellarcore::transaction::special_transaction::TransactionPayload;
...
pub fn instant_asset_lock_proof_transaction_fixture(
    ...
    // We are going to fund 1 Hellar and
...
/// 2. It uses the generated private key to create an asset lock proof. This proves the commitment of some asset (e.g., Hellar) which will be used to top up the identity.
...
pub fn create_identity_top_up_transition(
    ...
    let asset_lock_proof =
        instant_asset_lock_proof_fixture(PrivateKey::new(secret_key, Network::Hellar));
...
/// The withdrawal amount is set to 0.001 Hellar. The function first bumps the revision
