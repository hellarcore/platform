...
pub struct Config {
    /// Hostname of the Hellar Platform node to connect to
    #[serde(default)]
    pub platform_host: String,
    /// Port of the Hellar Platform node grpc interface
    #[serde(default)]
    pub platform_port: u16,
    /// Port of the Hellar Core RPC interface running on the Hellar Platform node
    #[serde(default)]
    pub core_port: u16,
    /// Username for Hellar Core RPC interface
    #[serde(default)]
    pub core_user: String,
    /// Password for Hellar Core RPC interface
    #[serde(default)]
...
impl Config {
    ...
    fn default_identity_id() -> Identifier {
        data_contracts::SystemDataContract::HPNS
            .source()
    ...
    fn default_data_contract_id() -> Identifier {
        data_contracts::SystemDataContract::HPNS.id()
    }
    ...
    fn default_document_id() -> Identifier {
        HPNS_HELLAR_TLD_DOCUMENT_ID.into()
    }
