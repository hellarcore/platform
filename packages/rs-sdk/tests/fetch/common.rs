use hpp::{data_contract::DataContractFactory, prelude::Identifier};

/// Create a mock document type for testing of mock API
pub fn mock_document_type() -> hpp::data_contract::document_type::DocumentType {
    use hpp::{
...
pub fn mock_data_contract(
    document_type: Option<&hpp::data_contract::document_type::DocumentType>,
) -> hpp::prelude::DataContract {
    use hpp::{
