//! Mocking support for Hellar SDK.
//!
...
//! Next step is to create mock query expectations on [MockHellarPlatformSdk] object returned by
//! [Sdk::mock()](crate::Sdk::mock()), using [MockHellarPlatformSdk::expect_fetch()]
//! and [MockHellarPlatformSdk::expect_fetch_many()].
//!
//!
//! ## Example
//!
...
pub use requests::*;
#[cfg(feature = "mocks")]
pub use sdk::MockHellarPlatformSdk;
