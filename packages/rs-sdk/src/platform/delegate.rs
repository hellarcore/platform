...
/// implements [TransportRequest](crate::platform::hapi::transport::TransportRequest) for the request enum and
...
/// [TransportRequest](crate::platform::hapi::transport::TransportRequest) (for request) and
/// [TransportResponse](crate::platform::hapi::transport::TransportResponse) (for response), where for a given variant,
...
macro_rules! delegate_transport_request_variant {
    ($request:ty, $response:ty, $($variant:ident),+) => {
        impl $crate::platform::hapi::transport::TransportRequest for $request {

            type Client = $crate::platform::hapi::transport::PlatformGrpcClient;

            type Response = $response;

            const SETTINGS_OVERRIDES: $crate::platform::hapi::RequestSettings = $crate::platform::hapi::RequestSettings::default();

            fn execute_transport<'c>(
                self,
                client: &'c mut Self::Client,
                settings: &$crate::platform::hapi::transport::AppliedRequestSettings,
            ) -> $crate::platform::hapi::transport::BoxFuture<'c, Result<Self::Response, <Self::Client as $crate::platform::hapi::transport::TransportClient>::Error>> {
    ...
    ($request:ty, $response:ty, $object:ty, $(($variant:ident, $req: ty, $resp: ty)),+) => {
        impl drive_proof_verifier::FromProof<$request> for $object {
            ...
            fn maybe_from_proof<'a, I: Into<Self::Request>, O: Into<Self::Response>>(
                request: I,
                response: O,
                version: &hpp::version::PlatformVersion,
...
/// delegate [TransportRequest](crate::platform::hapi::transport::TransportRequest)
...
/// [TransportRequest](crate::platform::hapi::transport::TransportRequest)
...
macro_rules! delegate_enum {
    ($request:ident, $response:ident, $object:ty, $(($variant:ident, $req: ty, $resp: ty)),+) => {
        ...
        impl $crate::platform::hapi::transport::TransportResponse for $response {}
