...
use hapi_grpc::platform::v0::get_identity_balance_and_revision_request::GetIdentityBalanceAndRevisionRequestV0;
use hapi_grpc::platform::v0::get_identity_balance_request::GetIdentityBalanceRequestV0;
use hapi_grpc::platform::v0::get_identity_by_public_key_hash_request::GetIdentityByPublicKeyHashRequestV0;
...
impl Query<IdentityRequest> for hpp::prelude::Identifier {
...
impl Query<GetIdentityBalanceRequest> for hpp::prelude::Identifier {
...
impl Query<GetIdentityBalanceAndRevisionRequest> for hpp::prelude::Identifier {
