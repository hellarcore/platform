...
use hellarcore_rpc::hellarcore::ProTxHash;
use hpp::block::epoch::EpochIndex;
use hpp::block::extended_epoch_info::ExtendedEpochInfo;
...
use rs_hapi_client::{transport::TransportRequest, DapiRequest, RequestSettings};
...
/// ## Example
///
/// An example use case is to fetch multiple [Data Contracts](hpp::prelude::DataContract) by their [Identifiers](Identifier).
        ...
        > + Sync,
{
    ...
    ///
    /// Most likely, one of the types defined in [`hapi_grpc::platform::v0`].
    ///
    ...
    /// Fetch (or search) multiple objects on the Hellar Platform
    ///
    /// [`FetchMany::fetch_many()`] is an asynchronous method that fetches multiple objects from the Hellar Platform.
    ///
...
///
/// Returns [Documents](hpp::document::Document) indexed by their [Identifier](hpp::prelude::Identifier).
///
...
/// ## Supported query types
///
/// * [EpochIndex](hpp::block::epoch::EpochIndex) - epoch index of first object to find; will return up to
...
/// indexed by [ProtocolVersion](hpp::util::deserializer::ProtocolVersion).
///
/// ## Supported query types
///
...
/// indexed by [ProTxHash](hellarcore_rpc::hellarcore::ProTxHash). Each item in this list represents
/// node protxhash and its preferred protocol version.
///
/// ## Supported query types
///
/// * [ProTxHash](hellarcore_rpc::hellarcore::ProTxHash) - proTxHash of first object to find; will return up to
/// [DEFAULT_NODES_VOTING_LIMIT](super::query::DEFAULT_NODES_VOTING_LIMIT) objects
/// * [`Option<ProTxHash>`](hellarcore_rpc::hellarcore::ProTxHash) - proTxHash that can be and [Option]; if it is `None`,
...
///
/// Returns [DataContracts](drive_proof_verifier::types::DataContracts) indexed by [Identifier](hpp::prelude::Identifier).
