...
use hellarcore_rpc::hellarcore::{hashes::Hash, ProTxHash};
use hpp::{block::epoch::EpochIndex, prelude::Identifier};
use drive::query::DriveQuery;
use rs_hapi_client::transport::TransportRequest;
...
/// [Identity](hpp::prelude::Identity), [DataContract](hpp::prelude::DataContract) and [Document](hpp::document::Document).
/// 2. [`DocumentQuery`] - fetches [Document](hpp::document::Document) based on search
/// conditions; see
...
/// ## Example
///
/// To fetch individual [Identity](hpp::prelude::Identity) object by its [Identifier](crate::platform::Identifier),
