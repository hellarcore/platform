//! # Hellar Platform Rust SDK
//!
//! This is the official Rust SDK for the Hellar Platform. Hellar Platform is a Layer 2 cryptocurrency technology that
//! builds upon the Hellar layer 1 network. This SDK provides an abstraction layer to simplify usage of the Hellar
//! Platform along with data models based on the Hellar Platform Protocol (DPP), a CRUD interface, and bindings
//! for other technologies such as C.
//!
//!
//! ## Hellar Platform Protocol Data Model
//!
//! SDK data model uses types defined in [Hellar Platform Protocol (DPP)](crate::platform::hpp). At this point, the following
//! types are supported:
//!
...
//! [query syntax documentation](https://docs.hellar.io/projects/platform/en/stable/docs/reference/query-syntax.html)
//! for more details.
