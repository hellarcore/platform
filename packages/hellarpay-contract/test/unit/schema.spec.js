...
const schema = require('../../schema/hellarpay.schema.json');
...
describe('Hellarpay Contract', () => {
  ...
  beforeEach(async () => {
    ...
    contract = hpp.dataContract.create(identityId, schema);
  });

  it('should have a valid contract definition', async () => {
    expect(() => hpp.dataContract.create(identityId, schema)).to.not.throw();
  });
    ...
    describe('Profile', () => {
      ...
      describe('displayName', () => {
        it('should have less than 25 chars length', async () => {
          ...
          const document = hpp.document.create(contract, identityId, 'profile', profileData);
      ...
      describe('avatarUrl', () => {
        ...
        it('should have less than 2048 chars length', async () => {
          profileData.avatarUrl = `https://github.com/hellarpay/hellar/wiki/Whitepaper?text=${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}${encodeURI(whitepaperMasternodeText)}`;
      ...
      it('should be valid', async () => {
        const profile = hpp.document.create(contract, identityId, 'profile', profileData);

        const result = profile.validate(hpp.protocolVersion);
    ...
    describe('Contact info', () => {
      ...
      describe('encToUserId', () => {
        it('should be defined', async () => {
          ...
          const document = hpp.document.create(contract, identityId, 'contactInfo', contactInfoData);
          const validationResult = document.validate(hpp.protocolVersion);
          const error = expectJsonSchemaError(validationResult);
    ...
    describe('Contact Request', () => {
      ...
      describe('toUserId', () => {
        it('should be defined', async () => {
          ...
          const document = hpp.document.create(contract, identityId, 'contactRequest', contactRequestData);
          const validationResult = document.validate(hpp.protocolVersion);
          const error = expectJsonSchemaError(validationResult);
