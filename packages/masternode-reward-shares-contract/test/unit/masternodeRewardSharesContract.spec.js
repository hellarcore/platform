...
describe('Masternode reward shares contract', () => {
  ...
  beforeEach(async () => {
    ...
    contract = hpp.dataContract.create(identityId, rewardSharingContractSchema);
  ...
  it('should have a valid contract definition', async () => {
    expect(() => hpp.dataContract.create(identityId, rewardSharingContractSchema))
      .to.not.throw();
  });
  ...
  describe('payToId', () => {
    it('should be defined', () => {
      ...
      const document = hpp.document.create(contract, identityId, 'rewardShare', rewardShare);
    ...
    it('should have no less than 32 bytes', () => {
      ...
      expect(() => hpp.document.create(contract, identityId, 'rewardShare', rewardShare))
        .to.throw();
    });
