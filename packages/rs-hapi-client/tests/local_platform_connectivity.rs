...
mod tests {
    ...
    use rs_hapi_client::{AddressList, DapiClient, DapiRequest, RequestSettings};
    ...
    async fn get_identity() {
        ...
        address_list.add_uri(rs_hapi_client::Uri::from_static("http://127.0.0.1:2443"));
        ...
        if let GetIdentityResponse {
            ...
            .await
            .expect("unable to perform hapi request")
        {
