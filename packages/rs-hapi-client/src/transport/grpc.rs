//! Listing of gRPC requests used in HAPI.

use std::time::Duration;

use hapi_grpc::core::v0::core_client::CoreClient;
use hapi_grpc::platform::v0::{self as platform_proto, platform_client::PlatformClient};
