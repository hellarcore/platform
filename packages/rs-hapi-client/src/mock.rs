//! Mock implementation of rs-hapi-client for testing
//!
//! rs-hapi-client provides `mocks` feature that makes it possible to mock the transport layer.
...
//!
//! See `tests/mock_hapi_client.rs` for an example.
