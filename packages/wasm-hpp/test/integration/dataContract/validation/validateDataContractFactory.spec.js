const lohellarCloneDeep = require('lohellar/cloneDeep');
...
describe.skip('validateDataContractFactory', () => {
  ...
  describe('documents', () => {
    ...
    it('should have valid property names (document types)', async () => {
      ...
      await Promise.all(
        validNames.map(async (name) => {
          const clonedDataContract = lohellarCloneDeep(rawDataContract);
    ...
    describe('Document schema', () => {
      ...
      describe('contentMediaType', () => {
        describe('application/x.hellar.hpp.identifier', () => {
