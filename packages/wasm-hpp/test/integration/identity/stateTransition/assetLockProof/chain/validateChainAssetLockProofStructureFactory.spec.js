const { Transaction, Script, PrivateKey } = require('@hellarpro/hellarcore-lib');
...
describe.skip('validateChainAssetLockProofStructureFactory', () => {
  ...
  beforeEach(async function beforeEach() {
    ...
    // Change endianness of raw txId bytes in outPoint to match expectation of hellarcore-rust
