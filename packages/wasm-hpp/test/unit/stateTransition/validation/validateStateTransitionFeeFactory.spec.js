...
describe.skip('validateStateTransitionFeeFactory', () => {
  ...
  beforeEach(async function beforeEach() {
    ...
    hpp = new HellarPlatformProtocol(getBlsMock(), stateRepositoryMock);
  ...
  describe('DataContractCreateTransition', () => {
    ...
    beforeEach(() => {
      ...
      dataContractCreateTransition = hpp.dataContract
  ...
  describe('DocumentsBatchTransition', () => {
    ...
    beforeEach(async () => {
      documentsBatchTransition = await hpp.document.createStateTransition({
