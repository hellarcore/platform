...
DIST_WASM_BINARY_BASE_64="$DIST_WASM_DIR/wasm_hpp_bg.js"

## Paths to wasm files produced by wasm-bindgen
WASM_DIR="$PWD/wasm"
WASM_TYPINGS_PATH="$WASM_DIR/wasm_hpp.d.ts"
WASM_JS_CODE_PATH="$WASM_DIR/wasm_hpp.js"
WASM_BINARY_PATH="$WASM_DIR/wasm_hpp_bg.wasm"
