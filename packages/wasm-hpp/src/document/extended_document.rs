...
use hpp::platform_value::{Bytes32, Value};
use hpp::prelude::{Identifier, Revision, TimestampMillis};
use hpp::util::json_schema::JsonSchemaExt;
use hpp::util::json_value::JsonValueExt;

use hpp::data_contract::document_type::accessors::DocumentTypeV0Getters;
use hpp::document::serialization_traits::ExtendedDocumentPlatformConversionMethodsV0;
