...
use hpp::platform_value::btreemap_extensions::{
    BTreeValueMapHelper, BTreeValueMapPathHelper, BTreeValueMapReplacementPathHelper,
};
use hpp::platform_value::converter::serde_json::BTreeValueJsonConverter;
use hpp::platform_value::ReplacementType;
...
use hpp::state_transition::documents_batch_transition::document_base_transition::v0::DocumentTransitionObjectLike;
use hpp::state_transition::documents_batch_transition::document_create_transition::v0::v0_methods::DocumentCreateTransitionV0Methods;
use hpp::state_transition::documents_batch_transition::document_create_transition::DocumentCreateTransition;
use hpp::state_transition::documents_batch_transition::document_transition::action_type::DocumentTransitionActionType;
use hpp::{
...
impl DocumentCreateTransitionWasm {
    ...
    //     //     .get_string(hpp::document::extended_document::property_names::DOCUMENT_TYPE_NAME)
    ...
    //                     );
    //                     lohellar_set(&js_value, suffix, id.into());
    //                 }
    //             }
    //         }
    //
    ...
    //                 {
    //                     let buffer = Buffer::from_bytes(&bytes);
    //                     lohellar_set(&js_value, suffix, buffer.into());
    //                 }
    //             }
    //         }
    //         Ok(js_value)
