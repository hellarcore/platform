...
use hpp::state_transition::documents_batch_transition::document_replace_transition::v0::v0_methods::DocumentReplaceTransitionV0Methods;
...
impl DocumentReplaceTransitionWasm {
    ...
    pub fn get_data(&self, data_contract: DataContractWasm) -> Result<JsValue, JsValue> {
        ...
        for path in identifier_paths {
            ...
            lohellar_set(&js_value, path, id.into());
        }
        for path in binary_paths {
            ...
            lohellar_set(&js_value, path, buffer.into());
        }
