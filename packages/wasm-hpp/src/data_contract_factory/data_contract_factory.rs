...
use hpp::{data_contract::DataContractFactory, platform_value, prelude::Identifier, ProtocolError};
...
use crate::{
    ...
    errors::{from_hpp_err, protocol_error::from_protocol_error},
    with_js_error,
};

use hpp::util::entropy_generator::EntropyGenerator;
...
impl DataContractFactoryWasm {
    ...
    //         Err(hpp::ProtocolError::InvalidDataContractError(err)) => {
