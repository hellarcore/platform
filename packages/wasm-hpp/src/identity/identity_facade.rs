...
use hpp::identity::{Identity, IdentityFacade};

use crate::buffer::Buffer;
use crate::errors::{from_hpp_err, RustConversionError};
...
use hpp::hellarcore::{consensus, InstantLock, Transaction};

use crate::identity::IdentityWasm;
use hpp::NonConsensusError;
...
impl IdentityFacadeWasm {
    ...
    //         Err(hpp::ProtocolError::InvalidIdentityError { errors, .. }) => {
