...
use hpp::identity::errors::UnknownAssetLockProofTypeError;
...
use hpp::identity::state_transition::asset_lock_proof::{AssetLockProof, AssetLockProofType};
...
//         .await
//         .map_err(|e| from_hpp_error_ref(&e))?;
//
