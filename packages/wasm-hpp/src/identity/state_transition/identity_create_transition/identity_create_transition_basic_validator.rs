use hpp::identity::state_transition::asset_lock_proof::{
...
use hpp::identity::state_transition::identity_create_transition::validation::basic::IdentityCreateTransitionBasicValidator;
use hpp::identity::state_transition::validate_public_key_signatures::PublicKeysSignaturesValidator;
use hpp::identity::validation::{
    PublicKeysValidator, RequiredPurposeAndSecurityLevelValidator, PUBLIC_KEY_SCHEMA_FOR_TRANSITION,
};

use hpp::version::{ProtocolVersionValidator, COMPATIBILITY_MAP, LATEST_VERSION};
...
impl IdentityCreateTransitionBasicValidatorWasm {
    ...
    pub fn new(
        ...
        .map_err(|e| from_hpp_err(ProtocolError::Generic(e.to_string())))?;
