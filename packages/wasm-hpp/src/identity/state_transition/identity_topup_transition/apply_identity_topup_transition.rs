use hpp::identity::state_transition::asset_lock_proof::AssetLockTransactionOutputFetcher;
use hpp::identity::state_transition::identity_topup_transition::ApplyIdentityTopUpTransition;
use std::sync::Arc;
