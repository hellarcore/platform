...
use hpp::state_transition::identity_topup_transition::fields::IDENTIFIER_FIELDS;
...
use hpp::platform_value::{string_encoding, ReplacementType, Value};
use hpp::serialization::PlatformSerializable;
use hpp::state_transition::identity_topup_transition::accessors::IdentityTopUpTransitionAccessorsV0;
