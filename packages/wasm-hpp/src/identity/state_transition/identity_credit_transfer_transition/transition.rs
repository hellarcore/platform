...
use hpp::platform_value::{ReplacementType, Value};
...
use hpp::identity::KeyType;
use hpp::platform_value::string_encoding::Encoding;
use hpp::platform_value::{string_encoding, BinaryData};
use hpp::serialization::{PlatformSerializable, ValueConvertible};
use hpp::state_transition::identity_credit_transfer_transition::accessors::IdentityCreditTransferTransitionAccessorsV0;
use hpp::state_transition::identity_credit_transfer_transition::fields::IDENTIFIER_FIELDS;
...
use hpp::state_transition::{StateTransition, StateTransitionIdentitySigned};
