...
use hpp::data_contract::state_transition::data_contract_create_transition::DataContractCreateTransition;
...
use hpp::{
    data_contract::state_transition::data_contract_create_transition::validation::state::{
        ...
        validate_data_contract_create_transition_state::validate_data_contract_create_transition_state as hpp_validate_data_contract_create_transition_state,
    },
    platform_value,
...
pub async fn validate_data_contract_create_transition_state(
    ...
    let validation_result = hpp_validate_data_contract_create_transition_state(
