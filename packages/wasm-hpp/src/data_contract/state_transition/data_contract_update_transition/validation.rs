...
use hpp::data_contract::state_transition::data_contract_update_transition::DataContractUpdateTransition;

use hpp::consensus::basic::value_error::ValueError;
use hpp::validation::{AsyncDataValidatorWithContext, SimpleConsensusValidationResult};
use hpp::{
    data_contract::state_transition::data_contract_update_transition::validation::{
        basic::{
            validate_indices_are_backward_compatible as hpp_validate_indices_are_backward_compatible,
            DataContractUpdateTransitionBasicValidator,
        },
        state::validate_data_contract_update_transition_state::validate_data_contract_update_transition_state as hpp_validate_data_contract_update_transition_state,
    },
    platform_value,
...
pub async fn validate_data_contract_update_transition_state(
    ...
    let result = hpp_validate_data_contract_update_transition_state(
...
pub fn validate_indices_are_backward_compatible(
    ...
    let result =
        hpp_validate_indices_are_backward_compatible(old_documents.iter(), new_documents.iter())
