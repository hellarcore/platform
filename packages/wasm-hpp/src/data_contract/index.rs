use hpp::{data_contract::document_type::IndexProperty, util::json_schema::Index};
...
/// Wrapper structure to serialize `Index` the way js-hpp expects it.
#[derive(Debug)]
...
/// Wrapper structure to serialize `InderProperty` the way js-hpp expects it.
#[derive(Debug)]
