...
use hpp::consensus::ConsensusError as DPPConsensusError;
use std::ops::Deref;
...
use hpp::consensus::fee::fee_error::FeeError;
use hpp::consensus::signature::SignatureError;

// TODO(versioning): remove
// use hpp::consensus::state::data_trigger::data_trigger_error::DataTriggerError;
