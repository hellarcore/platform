use hpp::HellarPlatformProtocolInitError;
...
pub fn from_hpp_err(pe: ProtocolError) -> JsValue {
    match pe {
...
pub fn from_hpp_init_error(e: HellarPlatformProtocolInitError) -> JsValue {
    match e {
        HellarPlatformProtocolInitError::SchemaDeserializationError(e) => e.to_string().into(),
        HellarPlatformProtocolInitError::ValidationError(e) => e.to_string().into(),
        HellarPlatformProtocolInitError::InvalidSchemaError(e) => e.to_string().into(),
