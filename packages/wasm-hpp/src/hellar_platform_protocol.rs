...
use hpp::hellar_platform_protocol::HellarPlatformProtocol;
use hpp::data_contract::DataContractFacade;
use hpp::identity::IdentityFacade;
use hpp::prelude::DataContract;
use hpp::state_transition::state_transition_factory::StateTransitionFactory;
use hpp::version::LATEST_VERSION;
...
#[wasm_bindgen(js_name=HellarPlatformProtocol)]
pub struct HellarPlatformProtocolWasm {
    protocol: HellarPlatformProtocol,
...
#[wasm_bindgen(js_class=HellarPlatformProtocol)]
impl HellarPlatformProtocolWasm {
    #[wasm_bindgen(constructor)]
    pub fn new(
        entropy_generator: ExternalEntropyGenerator,
        maybe_protocol_version: Option<u32>,
    ) -> Result<HellarPlatformProtocolWasm, JsValue> {
        ...
        let protocol = HellarPlatformProtocol::new(protocol_version);
