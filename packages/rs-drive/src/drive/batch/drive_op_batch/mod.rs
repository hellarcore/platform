...
mod tests {
    ...
    #[test]
    fn test_add_multiple_hellarpay_documents_individually_should_succeed() {
        ...
        drive_operations.push(DocumentOperation(AddDocumentForContract {
            document_and_contract_info: DocumentAndContractInfo {
                owned_document_info: OwnedDocumentInfo {
                    document_info: DocumentRefInfo((&hellarpay_cr_document, None)),
                    owner_id: None,
                },
                contract: &contract,
        ...
        let hellarpay_cr_1_document = json_document_to_document(
        ...
        drive_operations.push(DocumentOperation(AddDocumentForContract {
            document_and_contract_info: DocumentAndContractInfo {
                owned_document_info: OwnedDocumentInfo {
                    document_info: DocumentRefInfo((&hellarpay_cr_1_document, None)),
                    owner_id: None,
                },
                contract: &contract,
                document_type: contract
    ...
    #[test]
    fn test_add_multiple_hellarpay_documents() {
        let drive: Drive = setup_drive_with_initial_state_structure();
