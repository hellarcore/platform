...
mod tests {
    ...
    mod apply_balance_change_from_fee_to_identity_operations {
        ...
        use crate::fee::op::LowLevelDriveOperation;
        use hpp::block::block_info::BlockInfo;
        use hpp::fee::epoch::{CreditsPerEpoch, GENESIS_EPOCH_INDEX};
        use hpp::fee::fee_result::refunds::{CreditsPerEpochByIdentifier, FeeRefunds};
        use hpp::fee::fee_result::FeeResult;
        use hpp::fee::{Credits, SignedCredits};
        use hpp::version::PlatformVersion;
