...
impl Drive {
    /// Checks if a key with a given public key hash already exists in the unique tree.
    ///
    ...
    pub fn has_unique_public_key_hash(
        ...
        match drive_version
            ...
            .fetch
            .public_key_hashes
            .has_unique_public_key_hash
        {
            0 => self.has_unique_public_key_hash_v0(public_key_hash, transaction, drive_version),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "has_unique_public_key_hash".to_string(),
    ...
    pub(crate) fn has_unique_public_key_hash_operations(
        ...
        match drive_version
            ...
            .has_unique_public_key_hash
        {
            0 => self.has_unique_public_key_hash_operations_v0(
                public_key_hash,
                transaction,
                drive_operations,
                drive_version,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "has_unique_public_key_hash_operations".to_string(),
                known_versions: vec![0],
                received: version,
            })),
        }
