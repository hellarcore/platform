...
mod tests {
    ...
    mod get {
        ...
        fn test_get_from_global_cache_when_block_cache_is_not_requested() {
            ...
            let fetch_info_global = Arc::new(DataContractFetchInfo::hpns_contract_fixture(
                protocol_version,
            ));
            ...
            let mut fetch_info_block =
                DataContractFetchInfo::hpns_contract_fixture(protocol_version);
        ...
        fn test_get_from_block_cache() {
            ...
            let fetch_info_block = Arc::new(DataContractFetchInfo::hpns_contract_fixture(
                protocol_version,
            ));
