...
use hpp::data_contracts::withdrawals_contract;
use hpp::data_contracts::withdrawals_contract::document_types::withdrawal;
use hpp::document::{Document, DocumentV0};
use hpp::platform_value::platform_value;
use hpp::state_transition::state_transitions::identity::identity_credit_withdrawal_transition::v0::IdentityCreditWithdrawalTransitionV0;
