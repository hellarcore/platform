...
pub mod document_types {
    pub mod domain {
        ...
        pub mod properties {
            ...
            pub const HELLAR_UNIQUE_IDENTITY_ID: &str = "hellarUniqueIdentityId";
            pub const HELLAR_ALIAS_IDENTITY_ID: &str = "hellarAliasIdentityId";
        }
    }
}
...
pub fn load_documents_schemas() -> Result<Value, Error> {
    serde_json::from_str(include_str!("../schema/hpns-contract-documents.json"))
}
