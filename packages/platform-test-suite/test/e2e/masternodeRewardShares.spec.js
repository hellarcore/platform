...
} = require('@hellarpro/masternode-reward-shares-contract/lib/systemIds');
...
describe('Masternode Reward Shares', () => {
  ...
  describe.skip('Masternode owner', () => {
    ...
    before(async function before() {
      ...
      const stateTransition = client.platform.hpp.identity.createIdentityUpdateTransition(
    ...
    it('should be able to create reward shares with existing identity', async () => {
      ...
      const stateTransition = client.platform.hpp.document.createStateTransition({
        create: [rewardShare],
      });
