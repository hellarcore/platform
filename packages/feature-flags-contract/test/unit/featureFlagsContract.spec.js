...
describe('Feature Flags contract', () => {
  ...
  beforeEach(async () => {
    ...
    dataContract = hpp.dataContract.create(identityId, featureFlagsContractDocumentsSchema);
  });

  it('should have a valid contract definition', async () => {
    expect(() => hpp.dataContract.create(identityId, featureFlagsContractDocumentsSchema))
      .to.not.throw();
  });
  ...
  describe('documents', () => {
    describe('updateConsensusParams', () => {
      ...
      it('should have at least three properties', () => {
        ...
        const document = hpp.document.create(dataContract, identityId, 'updateConsensusParams', rawUpdateConsensusParamsDocument);
      ...
      describe('block', () => {
        ...
        it('should be valid', async () => {
          const updateConsensusParams = hpp.document.create(dataContract, identityId, 'updateConsensusParams', rawUpdateConsensusParamsDocument);

          const result = updateConsensusParams.validate(hpp.protocolVersion);
