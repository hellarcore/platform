const { signStateTransition } = require('hellar/build/SDK/Client/Platform/signStateTransition');
...
module.exports = {
  ...
  stateTransitions: {
    ...
    'Publish Data Contract': async (context) => {
      ...
      const stateTransition = platform.hpp.dataContract.createDataContractCreateTransition(
        dataContract,
      );
