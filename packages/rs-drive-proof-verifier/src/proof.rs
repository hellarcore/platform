...
use hapi_grpc::platform::v0::get_protocol_version_upgrade_vote_status_request::{
    self, GetProtocolVersionUpgradeVoteStatusRequestV0,
};
use hapi_grpc::platform::v0::security_level_map::KeyKindRequestType as GrpcKeyKind;
...
use hpp::hellarcore::ProTxHash;
use hpp::document::{Document, DocumentV0Getters};
use hpp::prelude::{DataContract, Identifier, Identity};
...
use crate::verify::verify_tenderhellar_proof;
...
/// from the Hellar Platform (including verification of grovedb-generated proofs and cryptographic proofs geneerated
/// by Tenderhellar).
///
/// gRPC responses, received from the Hellar Platform in response to requests containing `prove: true`, contain
/// GroveDB proof structure (including encapsulated objects) and metadata required to verify cryptographic proof
/// generated by the Tenderhellar. This trait provides methods that parse and verify the proof and retrieve the requested
/// object (or information that the object does not exist) in one step.
///
/// This trait is implemented by several objects defined in [Hellar Platform Protocol](hpp), like [Identity],
...
impl FromProof<platform::GetIdentityRequest> for Identity {
        ...
        Identity: Sized + 'a,
    {
        ...
        verify_tenderhellar_proof(proof, mtd, &root_hash, provider)?;
