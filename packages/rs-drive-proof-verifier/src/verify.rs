use hapi_grpc::platform::v0::{Proof, ResponseMetadata};
...
use crate::QuorumInfoProvider;

/// Verify cryptographic proof generated by Tenderhellar
///
/// This function verifies the cryptographic proof generated by Tenderhellar.
/// It verifies the signature of the proof using the public key of the quorum.
///
/// ## Parameters
///
/// - `proof`: The cryptographic proof generated by Tenderhellar
/// - `mtd`: The metadata of the response from Hellar Platform
/// - `root_hash`: The root hash of the response from Hellar Platform
...
///
pub(crate) fn verify_tenderhellar_proof(
    proof: &Proof,
...
/// Verify signature for [sign_digest](tenderhellar_abci::signatures::SignDigest), using provided `public_key`
