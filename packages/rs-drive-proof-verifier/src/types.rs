...
//!
//! Some HAPI requests return response types that are not defined in the Hellar Platform Protocol,
//! like [GetIdentityBalanceRequest](hapi_grpc::platform::v0::GetIdentityBalanceRequest) which returns [`u64`].
