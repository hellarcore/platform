use anyhow::anyhow;
use hellarcore::secp256k1::{PublicKey as RawPublicKey, SecretKey as RawSecretKey};
...
pub fn get_compressed_public_ec_key(private_key: &[u8]) -> Result<[u8; 33], ProtocolError> {
    ...
    let secp = hellarcore::secp256k1::Secp256k1::new();
...
//         let secp = hellarcore::secp256k1::Secp256k1::new();
//         let mut rng = hellarcore::secp256k1::rand::thread_rng();
...
//
//         let bls_private =
//             bls_signatures::PrivateKey::generate_hellar(&mut std_rng).expect("expected private key");
