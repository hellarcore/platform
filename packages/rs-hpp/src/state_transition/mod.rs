...
impl StateTransition {
    ...
    pub fn sign(
        ...
        match identity_public_key.key_type() {
            ...
            // https://github.com/hellarpro/platform/blob/6b02b26e5cd3a7c877c5fdfe40c4a4385a8dda15/packages/js-hpp/lib/stateTransition/AbstractStateTransitionIdentitySigned.js#L108
    ...
    pub fn sign_by_private_key(
        ...
        match key_type {
            ...
            // https://github.com/hellarpro/platform/blob/9c8e6a3b6afbc330a6ab551a689de8ccd63f9120/packages/js-hpp/lib/stateTransition/AbstractStateTransition.js#L169
            ...
            // the default behavior from
            // https://github.com/hellarpro/platform/blob/6b02b26e5cd3a7c877c5fdfe40c4a4385a8dda15/packages/js-hpp/lib/stateTransition/AbstractStateTransition.js#L187
            // is to return the error for the BIP13_SCRIPT_HASH
            KeyType::BIP13_SCRIPT_HASH | KeyType::EDDSA_25519_HASH160 => {
    ...
    pub fn verify_signature(
        ...
        match public_key.key_type() {
            ...
            // per https://github.com/hellarpro/platform/pull/353, signing and verification is not supported
