...
#[derive(Error, Debug)]
pub enum HellarPlatformProtocolInitError {
    #[error(transparent)]
...
impl From<serde_json::Error> for HellarPlatformProtocolInitError {
    fn from(error: serde_json::Error) -> Self {
        Self::SchemaDeserializationError(error)
    }
}

impl<'a> From<ValidationError<'a>> for HellarPlatformProtocolInitError {
