...
use super::get_hellarpay_contract_fixture;
...
pub fn get_contact_request_document_fixture(
    ...
    let data_contract = get_hellarpay_contract_fixture(None, protocol_version).data_contract_owned();
    ...
    factory
        ...
        .expect("the document hellarpay contact request should be created")
}
