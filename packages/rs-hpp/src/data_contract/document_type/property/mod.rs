...
impl DocumentPropertyType {
    ...
    pub fn encode_value_ref_with_size(
        ...
        return match self {
            ...
            // TODO: Make the same as in https://github.com/hellarpay/platform/blob/8d2a9e54d62b77581c44a15a09a2c61864af37d3/packages/rs-hpp/src/document/v0/serialize.rs#L161
