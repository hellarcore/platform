mod test {
    ...
    fn deserialize_from_cbor_with_contract_inner() {
        ...
        //     "../rs-drive/tests/supporting_files/contract/hellarpay/hellarpay-contract.json",
        //     false,
        //     platform_version,
        // )
        //     .expect("expected to get cbor document");
        //
        // let cbor = hellarpay_contract.to_cbor(platform_version).expect("expected cbor");
        //
        // std::fs::write("../rs-drive/tests/supporting_files/contract/hellarpay/hellarpay-contract-cbor.bin",cbor);

        let cbor_bytes = std::fs::read(
            "../rs-drive/tests/supporting_files/contract/hellarpay/hellarpay-contract-cbor.bin",
        )
        .unwrap();
