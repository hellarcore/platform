...
const { default: loadWasmDpp, deserializeConsensusError } = require('@hellarpro/wasm-hpp');

const GrpcErrorCodes = require('@hellarpro/grpc-common/lib/server/error/GrpcErrorCodes');
const AlreadyExistsGrpcError = require('@hellarpro/grpc-common/lib/server/error/AlreadyExistsGrpcError');
...
async function createGrpcErrorFromDriveResponse(code, info) {
  ...
  // Undefined Drive and HAPI errors
