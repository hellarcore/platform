...
const TransactionErrorResult = require('../../../externalApis/tenderhellar/waitForTransactionToBeProvable/transactionResult/TransactionErrorResult');
...
function waitForStateTransitionResultHandlerFactory(
  ...
  async function waitForStateTransitionResultHandler(call) {
    ...
    if (prove) {
      const stateTransition = await hpp.stateTransition.createFromBuffer(
